...
- [x] T001 Create `SupplierVerificationStatus` PHP 8.1 backed enum — `backend/app/Enums/SupplierVerificationStatus.php`
  - Cases: `Pending = 'pending'`, `Verified = 'verified'`, `Suspended = 'suspended'`
  - Declare `strict_types=1`; namespace `App\Enums`

- [x] T002 Create migration `create_supplier_profiles_table` (20 columns) — `backend/database/migrations/2026_04_15_000001_create_supplier_profiles_table.php`
...
- [x] T003 Create `SupplierProfile` Eloquent model — `backend/app/Models/SupplierProfile.php`
...
- [x] T004 Add `supplierProfile()` HasOne relationship to `User` model — `backend/app/Models/User.php` _(MODIFY)_
...
- [x] T005 Create `SupplierProfileFactory` with verification states — `backend/database/factories/SupplierProfileFactory.php`
...
- [x] T006 Create `SupplierRepositoryInterface` — `backend/app/Repositories/Contracts/SupplierRepositoryInterface.php`
...
- [x] T007 Create `SupplierRepository` — `backend/app/Repositories/SupplierRepository.php`
...
- [x] T008 Create `SupplierService` — `backend/app/Services/SupplierService.php`
...
- [x] T009 Register `SupplierRepository` binding and route model binding in `AppServiceProvider` — `backend/app/Providers/AppServiceProvider.php` _(MODIFY)_
...
- [x] T010 [P] [US1,US2] Create `StoreSupplierRequest` — `backend/app/Http/Requests/Supplier/StoreSupplierRequest.php`
...
- [x] T011 [P] [US7] Create `UpdateSupplierRequest` — `backend/app/Http/Requests/Supplier/UpdateSupplierRequest.php`
...
- [x] T012 [P] [US5] Create `VerifySupplierRequest` — `backend/app/Http/Requests/Supplier/VerifySupplierRequest.php`
...
- [x] T013 [P] [US6] Create `SuspendSupplierRequest` — `backend/app/Http/Requests/Supplier/SuspendSupplierRequest.php`
  - Mirrors `VerifySupplierRequest` exactly; no body; `authorize()` → `true`; `rules()` → `[]`

- [x] T014 [P] Create `SupplierPolicy` — `backend/app/Policies/SupplierPolicy.php`
...
- [x] T015 [P] Create `SupplierResource` — `backend/app/Http/Resources/SupplierResource.php`
...
- [x] T016 [US1,US2,US3,US4,US5,US6,US7,US8] Create `SupplierController` (7 actions + products stub) — `backend/app/Http/Controllers/Api/V1/SupplierController.php`
...
- [x] T017 Create supplier route definitions — `backend/routes/api/v1/suppliers.php`
...
- [x] T018 Register supplier route file in main API router — `backend/routes/api.php` _(MODIFY)_
...
- [x] T019 Create Supplier TypeScript type definitions — `frontend/types/supplier.ts`
...
- [x] T020 Create `useSupplier` API composable — `frontend/composables/useSupplier.ts`
...
- [x] T021 Create `useSupplierStore` Pinia store — `frontend/stores/useSupplierStore.ts`
...
- [x] T022 [P] [US3,US4] Create `SupplierCard.vue` component — `frontend/components/supplier/SupplierCard.vue`
...
- [x] T023 [P] [US3,US4,US5,US6,US8] Create `VerificationStatusBadge.vue` component — `frontend/components/supplier/VerificationStatusBadge.vue`
...
- [x] T024 [US1,US7] Create `SupplierForm.vue` component — `frontend/components/supplier/SupplierForm.vue`
...
- [x] T025 [US3] Create supplier directory (public) page — `frontend/pages/suppliers/index.vue`
...
- [x] T026 [US4] Create supplier profile detail page — `frontend/pages/suppliers/[id].vue`
  - Layout: `default`; access: public
...
- [x] T027 [US1,US7] Create contractor supplier profile management page — `frontend/pages/dashboard/supplier/profile.vue`
...
- [x] T028 [US2,US5,US6,US8] Create admin supplier management page — `frontend/pages/admin/suppliers/index.vue`
...
- [x] T029 Create `SupplierSeeder` — `backend/database/seeders/SupplierSeeder.php`
...
- [x] T030 [P] Create Arabic backend translation file — `backend/lang/ar/suppliers.php`
...
- [x] T031 [P] Create English backend translation file — `backend/lang/en/suppliers.php`
  - Mirror of T030 with English values
  - Key/structure must be identical to `ar/suppliers.php`

- [x] T032 [P] Add supplier locale keys to Arabic frontend locale — `frontend/locales/ar.json` _(MODIFY)_
...
- [x] T033 [P] Add supplier locale keys to English frontend locale — `frontend/locales/en.json` _(MODIFY)_
  - Mirror of T032 additions in English; key structure must be identical

- [x] T034 [US1,US2,US3,US4,US7,US8] Create `SupplierControllerTest` feature test suite — `backend/tests/Feature/Api/V1/SupplierControllerTest.php`
...
- [x] T035 [US5,US6] Create `SupplierVerificationWorkflowTest` feature test suite — `backend/tests/Feature/Api/V1/SupplierVerificationWorkflowTest.php`
...
- [x] T036 [US1,US2,US5,US6,US7,US8] Create `SupplierServiceTest` unit test suite — `backend/tests/Unit/Services/SupplierServiceTest.php`
...
- [x] T037 Run backend lint and static analysis — `backend/`
...
- [x] T038 Run backend PHPUnit tests scoped to Supplier — `backend/`
...
- [x] T039 Run frontend lint, TypeScript typecheck, and Vitest tests — `frontend/`
