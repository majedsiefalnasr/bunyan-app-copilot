...
export const NAV_ITEMS_BY_ROLE: Record<UserRole, NavItem[]> = {
  ...
  [UserRole.FieldEngineer]: [
    ...
    { labelKey: 'nav.submit_report', icon: 'i-heroicons-paper-airplane', to: '/reports/create' },
  ],
  [UserRole.Admin]: [
    { labelKey: 'nav.dashboard', icon: 'i-heroicons-home', to: '/dashboard' },
    ...
    { labelKey: 'nav.configuration', icon: 'i-heroicons-cog-6-tooth', to: '/admin/configuration' },
