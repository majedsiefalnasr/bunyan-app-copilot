...
test.describe('Category Delete E2E', () => {
  ...
  test('should delete category with confirmation dialog', async ({
    page,
  }) => {
    ...
    if (deleteButtons.length > 0) {
      ...
      const confirmButton = page.locator(
        'button:has-text("حذف"), button:has-text("تأكيد")'
      );
  ...
  test('should soft-delete category (grayed out, marked as deleted)', async ({
    page,
  }) => {
    await page.goto('/admin/categories');
    await page.waitForLoadState('networkidle');
  ...
  test('should verify children remain after parent soft-delete', async ({
    page,
  }) => {
    await page.goto('/admin/categories');
    await page.waitForLoadState('networkidle');
  ...
  test('should allow admin to view soft-deleted categories', async ({
    page,
  }) => {
    await page.goto('/admin/categories');
    await page.waitForLoadState('networkidle');
    ...
    if (await showDeletedToggle.isVisible()) {
      ...
      const deletedCategories = await page
      .locator('[class*="deleted"], [class*="inactive"]')
        .all();
  ...
  test('should cancel delete without removing category', async ({
    page,
  }) => {
    await page.goto('/admin/categories');
    await page.waitForLoadState('networkidle');
  ...
  test('should show deletion confirmation message', async ({
    page,
  }) => {
    await page.goto('/admin/categories');
    await page.waitForLoadState('networkidle');
  ...
  test('should disable delete button for categories without permission', async ({
    page,
  }) => {
    await page.goto('/admin/categories');
    await page.waitForLoadState('networkidle');
